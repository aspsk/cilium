...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RealPolicyKey) DeepCopyInto(out *RealPolicyKey) {
	*out = *in
	out.NexthdrPrefix = in.NexthdrPrefix
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RealPolicyKey.
func (in *RealPolicyKey) DeepCopy() *RealPolicyKey {
	if in == nil {
		return nil
	}
	out := new(RealPolicyKey)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyMapKey is an autogenerated deepcopy function, copying the receiver, creating a new bpf.MapKey.
func (in *RealPolicyKey) DeepCopyMapKey() bpf.MapKey {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
