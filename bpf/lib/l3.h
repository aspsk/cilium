...
/*
 * When the host routing is enabled we need to check policies at source.
 * Otherwise, as the skb will be delivered directly to pod's namespace,
 * the ingress policy (the cil_to_container BPF program) will be bypassed.
 */
